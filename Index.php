  ...
  <body>
    ...
    <div class="mainWrapper">
        ...
        <div class="searchOrFind">      
          ...
          <div class="formChoice">
           <div class="styleform1">
            <form action="" method="post" name="search" id="searchForm" onsubmit="Aler()">
     ...
     <div class="sellWrapper">
      <div class="styleform1">
        <form action="" method="post" name="sell" onsubmit="return alert('You must be logged in'); return false">
          <div class="wrapSelector">
            <p>New/Used</p>
  ...
  <input type="submit" value="Upload" id="upLoad">
    ...
    <div class="sendMesg">
       <form action="" method="post" id="formSendMsg">
         <div class="formMsg">
           <p>Log in and Ask a Question </p>
        <input  name="sendMsgText" id="sendMsgText" placeholder="Log in and ask a question"></input>
